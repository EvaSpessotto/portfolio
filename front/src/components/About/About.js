    ...
    <Container id="about">
      ...
      <Row className="mt-5">
        <Col lg="6" xs="12" className="pres-about">
          ...
          <p>
            Je vis dans la région de Toulousoù j'ai étudié pendant deux ans le Design Graphique au <a href={links.arenes} className="yellow">lycée des Arènes</a>. 
            J’ai ensuite fait une licence professionnelle en Communication digitale à <a href={links.tarbes} className="blue">l'IUT de Tarbes</a> où j’étais alternante graphiste à Total. 
            C'est durant cette année là que je me suis réellement passionnée pour le développement web, 
            j'ai alors décidé de faire une formation Développeur web à la <a href={links.wcs} className="red">Wild Code School</a> de Toulouse.
          </p>
          <p>
            ...
            stage chez <a href={links.commit42} className="yellow">Commit42</a>, un studio de développement web à Toulouse.
          </p>
          <p>
            Le web n’est pas la seule chose qui me fait vibrer, j’aime tout particulièrement l'illustration, 
            la <a href={links.serigraphie} className="blue">sérigraphie</a> et la photographie (<a href={links.argentique} className="red">argentique</a> comme numérique). Étant assez adepte du DIY, 
